...
public class Request2
    implements org.apache.thrift.TBase<Request2, Request2._Fields>,
        java.io.Serializable,
        Cloneable,
        Comparable<Request2> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
      new org.apache.thrift.protocol.TStruct("Request2");
  ...
  private static final org.apache.thrift.protocol.TField STAGE_ID_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "stageId", org.apache.thrift.protocol.TType.I32, (short) 2);
  private static final org.apache.thrift.protocol.TField PARTITION_ID_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "partitionId", org.apache.thrift.protocol.TType.I32, (short) 3);
  private static final org.apache.thrift.protocol.TField NUM_MAPPERS_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "numMappers", org.apache.thrift.protocol.TType.I32, (short) 4);
  private static final org.apache.thrift.protocol.TField NUM_REDUCERS_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "numReducers", org.apache.thrift.protocol.TType.I32, (short) 5);
  private static final org.apache.thrift.protocol.TField SHUFFLE_ID_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "shuffleId", org.apache.thrift.protocol.TType.I32, (short) 6);
  private static final org.apache.thrift.protocol.TField INPUT_LINES_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "inputLines", org.apache.thrift.protocol.TType.I64, (short) 7);
  private static final org.apache.thrift.protocol.TField OUTPUT_SIZES_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "outputSizes", org.apache.thrift.protocol.TType.LIST, (short) 8);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
      new Request2StandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
      new Request2TupleSchemeFactory();
  ...
  public Request2(Request2 other) {
    ...
    if (other.isSetOutputSizes()) {
      java.util.List<java.lang.Long> __this__outputSizes =
          new java.util.ArrayList<java.lang.Long>(other.outputSizes);
  ...
  public Request2 setApplicationId(
  ...
  public void unsetStageId() {
    __isset_bitfield =
        org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __STAGEID_ISSET_ID);
  }
  ...
  public void setStageIdIsSet(boolean value) {
    __isset_bitfield =
        org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __STAGEID_ISSET_ID, value);
  }
  ...
  public void unsetPartitionId() {
    __isset_bitfield =
        org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __PARTITIONID_ISSET_ID);
  }
  ...
  public void setPartitionIdIsSet(boolean value) {
    __isset_bitfield =
        org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __PARTITIONID_ISSET_ID, value);
  }
  ...
  public void unsetInputLines() {
    __isset_bitfield =
        org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __INPUTLINES_ISSET_ID);
  }
  ...
  public void setInputLinesIsSet(boolean value) {
    __isset_bitfield =
        org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __INPUTLINES_ISSET_ID, value);
  }
  ...
  public Request2 setOutputSizes(
      @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> outputSizes) {
    this.outputSizes = outputSizes;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof Request2) return this.equals((Request2) that);
    return false;
  }
  ...
  public boolean equals(Request2 that) {
    ...
    if (this_present_stageId || that_present_stageId) {
      if (!(this_present_stageId && that_present_stageId)) return false;
      if (this.stageId != that.stageId) return false;
    }
    ...
    if (this_present_partitionId || that_present_partitionId) {
      if (!(this_present_partitionId && that_present_partitionId)) return false;
      if (this.partitionId != that.partitionId) return false;
    }
    ...
    if (this_present_inputLines || that_present_inputLines) {
      if (!(this_present_inputLines && that_present_inputLines)) return false;
      if (this.inputLines != that.inputLines) return false;
    }
    ...
    if (this_present_outputSizes || that_present_outputSizes) {
      if (!(this_present_outputSizes && that_present_outputSizes)) return false;
      if (!this.outputSizes.equals(that.outputSizes)) return false;
    }
  ...
  public int hashCode() {
    ...
    if (isSetOutputSizes()) hashCode = hashCode * 8191 + outputSizes.hashCode();
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'stageId' because it's a primitive and you chose the non-beans
    // generator.
    // alas, we cannot check 'partitionId' because it's a primitive and you chose the non-beans
    // generator.
    ...
    // generator.
    // alas, we cannot check 'inputLines' because it's a primitive and you chose the non-beans
    // generator.
    if (outputSizes == null) {
      throw new org.apache.thrift.protocol.TProtocolException(
          "Required field 'outputSizes' was not present! Struct: " + toString());
    }
  ...
  private static class Request2StandardSchemeFactory
  ...
  private static class Request2StandardScheme
      extends org.apache.thrift.scheme.StandardScheme<Request2> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Request2 struct)
        throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outputSizes = new java.util.ArrayList<java.lang.Long>(_list88.size);
                long _elem89;
                for (int _i90 = 0; _i90 < _list88.size; ++_i90) {
                  _elem89 = iprot.readI64();
                  struct.outputSizes.add(_elem89);
                }
                iprot.readListEnd();
              }
      ...
      if (!struct.isSetStageId()) {
        throw new org.apache.thrift.protocol.TProtocolException(
            "Required field 'stageId' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetPartitionId()) {
        throw new org.apache.thrift.protocol.TProtocolException(
            "Required field 'partitionId' was not found in serialized data! Struct: " + toString());
      }
      ...
      if (!struct.isSetInputLines()) {
        throw new org.apache.thrift.protocol.TProtocolException(
            "Required field 'inputLines' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }

    public void write(org.apache.thrift.protocol.TProtocol oprot, Request2 struct)
        throws org.apache.thrift.TException {
      struct.validate();
        ...
        oprot.writeFieldBegin(OUTPUT_SIZES_FIELD_DESC);
        {
          oprot.writeListBegin(
              new org.apache.thrift.protocol.TList(
                  org.apache.thrift.protocol.TType.I64, struct.outputSizes.size()));
          for (long _iter91 : struct.outputSizes) {
  ...
  private static class Request2TupleSchemeFactory
      implements org.apache.thrift.scheme.SchemeFactory {
  ...
  private static class Request2TupleScheme extends org.apache.thrift.scheme.TupleScheme<Request2> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Request2 struct)
        throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.inputLines);
      {
        ...
        for (long _iter92 : struct.outputSizes) {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Request2 struct)
        throws org.apache.thrift.TException {
      ...
      struct.setInputLinesIsSet(true);
      {
        ...
        struct.outputSizes = new java.util.ArrayList<java.lang.Long>(_list93.size);
        long _elem94;
        for (int _i95 = 0; _i95 < _list93.size; ++_i95) {
          _elem94 = iprot.readI64();
          struct.outputSizes.add(_elem94);
        }
      }
      struct.setOutputSizesIsSet(true);
    }
