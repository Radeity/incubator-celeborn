...
public class Request1
    implements org.apache.thrift.TBase<Request1, Request1._Fields>,
        java.io.Serializable,
        Cloneable,
        Comparable<Request1> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
      new org.apache.thrift.protocol.TStruct("Request1");

  private static final org.apache.thrift.protocol.TField NUM_MAPPERS_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "numMappers", org.apache.thrift.protocol.TType.I32, (short) 1);
  private static final org.apache.thrift.protocol.TField NUM_REDUCERS_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "numReducers", org.apache.thrift.protocol.TType.I32, (short) 2);
  private static final org.apache.thrift.protocol.TField NUM_SITES_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "numSites", org.apache.thrift.protocol.TType.I32, (short) 3);
  private static final org.apache.thrift.protocol.TField BANDWIDTH_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "bandwidth", org.apache.thrift.protocol.TType.LIST, (short) 4);
  private static final org.apache.thrift.protocol.TField FINISH_TIME_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "finishTime", org.apache.thrift.protocol.TType.LIST, (short) 5);
  private static final org.apache.thrift.protocol.TField OUTPUT_SIZE_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "outputSize", org.apache.thrift.protocol.TType.LIST, (short) 6);
  private static final org.apache.thrift.protocol.TField SITE_LOAD_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "siteLoad", org.apache.thrift.protocol.TType.LIST, (short) 7);
  private static final org.apache.thrift.protocol.TField ALPHA_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "alpha", org.apache.thrift.protocol.TType.DOUBLE, (short) 8);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
      new Request1StandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
      new Request1TupleSchemeFactory();

  public int numMappers; // required
  public int numReducers; // required
  public int numSites; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.Integer>>
      bandwidth; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.Integer>>
      finishTime; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<
      ...
      outputSize; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double>
      siteLoad; // optional
  ...
  private static final _Fields optionals[] = {
    _Fields.BANDWIDTH, _Fields.FINISH_TIME, _Fields.OUTPUT_SIZE, _Fields.SITE_LOAD
  };
  ...
  public Request1(int numMappers, int numReducers, int numSites, double alpha) {
    this();
  ...
  public Request1(Request1 other) {
    ...
    if (other.isSetBandwidth()) {
      java.util.List<java.util.List<java.lang.Integer>> __this__bandwidth =
          new java.util.ArrayList<java.util.List<java.lang.Integer>>(other.bandwidth.size());
      for (java.util.List<java.lang.Integer> other_element : other.bandwidth) {
        java.util.List<java.lang.Integer> __this__bandwidth_copy =
            new java.util.ArrayList<java.lang.Integer>(other_element);
        __this__bandwidth.add(__this__bandwidth_copy);
      }
      this.bandwidth = __this__bandwidth;
    }
    if (other.isSetFinishTime()) {
      java.util.List<java.util.List<java.lang.Integer>> __this__finishTime =
          new java.util.ArrayList<java.util.List<java.lang.Integer>>(other.finishTime.size());
      for (java.util.List<java.lang.Integer> other_element : other.finishTime) {
        java.util.List<java.lang.Integer> __this__finishTime_copy =
            new java.util.ArrayList<java.lang.Integer>(other_element);
    ...
    if (other.isSetSiteLoad()) {
      java.util.List<java.lang.Double> __this__siteLoad =
          new java.util.ArrayList<java.lang.Double>(other.siteLoad);
  ...
  public void unsetNumSites() {
    __isset_bitfield =
        org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __NUMSITES_ISSET_ID);
  }
  ...
  public void setNumSitesIsSet(boolean value) {
    __isset_bitfield =
        org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __NUMSITES_ISSET_ID, value);
  }
  ...
  public Request1 setSiteLoad(
      @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> siteLoad) {
  ...
  public void setAlphaIsSet(boolean value) {
    __isset_bitfield =
        org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ALPHA_ISSET_ID, value);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof Request1) return this.equals((Request1) that);
    return false;
  }
  ...
  public boolean equals(Request1 that) {
    ...
    if (this_present_numSites || that_present_numSites) {
      if (!(this_present_numSites && that_present_numSites)) return false;
      if (this.numSites != that.numSites) return false;
    }
    ...
    if (this_present_bandwidth || that_present_bandwidth) {
      if (!(this_present_bandwidth && that_present_bandwidth)) return false;
      if (!this.bandwidth.equals(that.bandwidth)) return false;
    }
    ...
    if (this_present_finishTime || that_present_finishTime) {
      if (!(this_present_finishTime && that_present_finishTime)) return false;
      if (!this.finishTime.equals(that.finishTime)) return false;
    }
    ...
    if (this_present_siteLoad || that_present_siteLoad) {
      if (!(this_present_siteLoad && that_present_siteLoad)) return false;
      if (!this.siteLoad.equals(that.siteLoad)) return false;
    }

    boolean this_present_alpha = true;
    boolean that_present_alpha = true;
    if (this_present_alpha || that_present_alpha) {
      if (!(this_present_alpha && that_present_alpha)) return false;
  ...
  public int hashCode() {
    ...
    if (isSetBandwidth()) hashCode = hashCode * 8191 + bandwidth.hashCode();

    hashCode = hashCode * 8191 + ((isSetFinishTime()) ? 131071 : 524287);
    if (isSetFinishTime()) hashCode = hashCode * 8191 + finishTime.hashCode();
    ...
    if (isSetSiteLoad()) hashCode = hashCode * 8191 + siteLoad.hashCode();
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // generator.
    // alas, we cannot check 'numSites' because it's a primitive and you chose the non-beans
    // generator.
  ...
  private static class Request1StandardSchemeFactory
  ...
  private static class Request1StandardScheme
      extends org.apache.thrift.scheme.StandardScheme<Request1> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Request1 struct)
        throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.bandwidth =
                    new java.util.ArrayList<java.util.List<java.lang.Integer>>(_list0.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.finishTime =
                    new java.util.ArrayList<java.util.List<java.lang.Integer>>(_list6.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outputSize =
                    new java.util.ArrayList<java.util.List<java.util.List<java.lang.Long>>>(
                        _list12.size);
                @org.apache.thrift.annotation.Nullable
                java.util.List<java.util.List<java.lang.Long>> _elem13;
      ...
      if (!struct.isSetNumSites()) {
        throw new org.apache.thrift.protocol.TProtocolException(
            "Required field 'numSites' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetAlpha()) {
        throw new org.apache.thrift.protocol.TProtocolException(
            "Required field 'alpha' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }

    public void write(org.apache.thrift.protocol.TProtocol oprot, Request1 struct)
        throws org.apache.thrift.TException {
      struct.validate();
          ...
          oprot.writeFieldBegin(BANDWIDTH_FIELD_DESC);
          {
            oprot.writeListBegin(
                new org.apache.thrift.protocol.TList(
                    org.apache.thrift.protocol.TType.LIST, struct.bandwidth.size()));
            for (java.util.List<java.lang.Integer> _iter24 : struct.bandwidth) {
              {
                oprot.writeListBegin(
                    new org.apache.thrift.protocol.TList(
                        org.apache.thrift.protocol.TType.I32, _iter24.size()));
      ...
      if (struct.finishTime != null) {
        if (struct.isSetFinishTime()) {
          oprot.writeFieldBegin(FINISH_TIME_FIELD_DESC);
          {
            oprot.writeListBegin(
                new org.apache.thrift.protocol.TList(
                    org.apache.thrift.protocol.TType.LIST, struct.finishTime.size()));
            for (java.util.List<java.lang.Integer> _iter26 : struct.finishTime) {
              {
                oprot.writeListBegin(
                    new org.apache.thrift.protocol.TList(
                        org.apache.thrift.protocol.TType.I32, _iter26.size()));
            ...
            for (java.util.List<java.util.List<java.lang.Long>> _iter28 : struct.outputSize) {
              {
                oprot.writeListBegin(
                    new org.apache.thrift.protocol.TList(
                        org.apache.thrift.protocol.TType.LIST, _iter28.size()));
                for (java.util.List<java.lang.Long> _iter29 : _iter28) {
                  {
                    oprot.writeListBegin(
                        new org.apache.thrift.protocol.TList(
                            org.apache.thrift.protocol.TType.I64, _iter29.size()));
      ...
      if (struct.siteLoad != null) {
        if (struct.isSetSiteLoad()) {
          oprot.writeFieldBegin(SITE_LOAD_FIELD_DESC);
          {
            oprot.writeListBegin(
                new org.apache.thrift.protocol.TList(
                    org.apache.thrift.protocol.TType.DOUBLE, struct.siteLoad.size()));
  ...
  private static class Request1TupleSchemeFactory
      implements org.apache.thrift.scheme.SchemeFactory {
  ...
  private static class Request1TupleScheme extends org.apache.thrift.scheme.TupleScheme<Request1> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Request1 struct)
        throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Request1 struct)
        throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.bandwidth =
              new java.util.ArrayList<java.util.List<java.lang.Integer>>(_list40.size);
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list46 =
              iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
          struct.finishTime =
              new java.util.ArrayList<java.util.List<java.lang.Integer>>(_list46.size);
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list52 =
              iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
          struct.outputSize =
              new java.util.ArrayList<java.util.List<java.util.List<java.lang.Long>>>(_list52.size);
          @org.apache.thrift.annotation.Nullable
          java.util.List<java.util.List<java.lang.Long>> _elem53;
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list61 =
